...
namespace AnyStatus.Apps.Windows.Infrastructure.Mvvm.Controls.PropertyGrid
{
    internal class PropertyBuilder : IPropertyBuilder
    {
        ...
        public PropertyBuilder(ILogger logger, IServiceProvider serviceProvider)
        {
            _logger = logger;
            _serviceProvider = serviceProvider;
        }

        public IProperty Build(object source, PropertyInfo propertyInfo, IEnumerable<IProperty> properties)
        {
